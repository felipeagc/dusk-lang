...
static const char *DUSK_BUILTIN_FUNCTION_NAMES[DUSK_BUILTIN_FUNCTION_COUNT] = {
    ...
    [DUSK_BUILTIN_FUNCTION_NORMALIZE] = "normalize",
    ...
    [DUSK_BUILTIN_FUNCTION_IMAGE_SAMPLE] = "imageSample",
    [DUSK_BUILTIN_FUNCTION_IMAGE_SAMPLE_LOD] = "imageSampleLod",
    [DUSK_BUILTIN_FUNCTION_IMAGE_LOAD] = "imageLoad",
    [DUSK_BUILTIN_FUNCTION_IMAGE_STORE] = "imageStore",
